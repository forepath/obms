...
class OrderNewSuccessfulApproval extends Notification
{
    /**
    ...
    protected function buildMailMessage(string $url, ShopOrderQueue $notifiable): MailMessage
    {
        $message = (new MailMessage())
            ...
            ->line(Lang::get('Your order :id has been placed successfully. It will be processed automatically within the next few minutes. You will be informed when the order status changes.', [
