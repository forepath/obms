...
class ProductLockFailure extends Notification
{
    /**
    ...
    protected function buildMailMessage(string $url, ShopOrderQueue $notifiable): MailMessage
    {
        $message = (new MailMessage())
            ...
            ->line(Lang::get('The contract of your order :id has expired. The products could not be automatically locked. However, if you don\'t re-activate the contract within :grace days all associated products will been removed permanently.', [
