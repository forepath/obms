...
class OrderUnsuccessfulApproval extends Notification
{
    /**
    ...
    protected function buildMailMessage(string $url, ShopOrderQueue $notifiable): MailMessage
    {
        $message = (new MailMessage())
            ->subject(Lang::get('Order not approved: ') . $notifiable->number)
            ->line(Lang::get('Your order :id has not been approved. It will not be set up. Please contact us if you have further questions.', [
