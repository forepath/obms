...
class OrderSuccessfulApproval extends Notification
{
    /**
    ...
    protected function buildMailMessage(string $url, ShopOrderQueue $notifiable): MailMessage
    {
        $message = (new MailMessage())
            ->subject(Lang::get('Order approved: ') . $notifiable->number)
            ->line(Lang::get('Your order :id has been approved successfully. It will be processed automatically within the next few minutes. You will be informed when the order status changes.', [
