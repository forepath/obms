...
class ProductUnlockSuccessful extends Notification
{
    /**
    ...
    protected function buildMailMessage(string $url, ShopOrderQueue $notifiable): MailMessage
    {
        $message = (new MailMessage())
            ...
            ->line(Lang::get('The contract of your order :id has been continued. All associated products were re-activated.', [
