...
class ProductRemovalSuccessful extends Notification
{
    /**
    ...
    protected function buildMailMessage(string $url, ShopOrderQueue $notifiable): MailMessage
    {
        $message = (new MailMessage())
            ->subject(Lang::get('Products removed: ') . $notifiable->number)
            ->line(Lang::get('The contract of your order :id has expired and the grace period of :grace days is over. All associated products have been removed permanently.', [
